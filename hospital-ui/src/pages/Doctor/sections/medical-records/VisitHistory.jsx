            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm space-y-3">
              <div className="flex flex-wrap items-center justify-between gap-2 border-b border-gray-100 pb-2">
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  ...
                  <span>•</span>
                  <span>Type: <span className="font-medium text-gray-800">{visit.encounterType}</span></span>
                </div>
                <span className="text-xs text-gray-400 font-mono">Attending: {visit.doctor}</span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs bg-gray-50/50 p-3 rounded-lg border border-gray-100">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed"><strong className="text-gray-900">S:</strong> {visit.notes.subjective}</p>
                  <p className="text-gray-700 leading-relaxed mt-1"><strong className="text-gray-900">O:</strong> {visit.notes.objective}</p>
                </div>
                <div>
                  <span className="font-bold text-gray-400 block uppercase tracking-tight mb-1">Clinical Assessment & Management Plan</span>
                  <p className="text-gray-700 leading-relaxed"><strong className="text-gray-900">A/P:</strong> {visit.notes.assessmentPlan}</p>
                </div>
              </div>
            </div>
          </div>
