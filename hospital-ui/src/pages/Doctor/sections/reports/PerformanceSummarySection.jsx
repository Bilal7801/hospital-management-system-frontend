...
import { Gauge, Hourglass, Zap, ShieldCheck } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white border border-gray-200 p-4 rounded-xl shadow-sm flex flex-col justify-between gap-4">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 bg-amber-50 text-amber-600 rounded-lg"><Hourglass className="w-4 h-4" /></div>
          </div>
          <div>
            <strong className="text-2xl font-bold text-gray-900">14.2 Mins</strong>
        ...
        <div className="bg-white border border-gray-200 p-4 rounded-xl shadow-sm flex flex-col justify-between gap-4">
          ...
          <div>
            <strong className="text-2xl font-bold text-gray-900">98.4% Out</strong>
        ...
        <div className="bg-white border border-gray-200 p-4 rounded-xl shadow-sm flex flex-col justify-between gap-4">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 bg-emerald-50 text-emerald-700 rounded-lg"><ShieldCheck className="w-4 h-4" /></div>
          </div>
          <div>
            <strong className="text-2xl font-bold text-gray-900">99.98% Acc</strong>
